...
struct _GstDataReschedule
{
  ...
  guint single_large_frame_size;       /**< number of frames in input buffer */
  guint accumulate_large_frame_number; /**< number of frames in output buffer */
  guint single_small_frame_size;       /**< number of frames in input buffer */
  guint accumulate_small_frame_number; /**< number of frames in output buffer */
